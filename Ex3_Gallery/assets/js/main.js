...
//эта функция делает видимым блок с рисунками для слайдшоу (изначально он невидим, чтобы

// избежать мерцания во время загрузки картинок) и запускает анимацию
...
//выжидаем пару секунд, чтобы картинки успели загрузиться...
